...
def run_testcase(spark, basePath, numQuestion):
    ...
    if base.check_path_exists(check_data_path):
        # if base.check_file_type(check_data_path, extension=extension):
            if base.check_schema_is_correct(check_data_path, base_path, spark, extension=extension, rowTag="Bai5"):
                base.check_content_files(check_data_path, base_path, spark, extension=extension, rowTag="Bai5")
